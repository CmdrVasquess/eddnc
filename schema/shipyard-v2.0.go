...
type ShipyardV20JsonHeader struct {
...
func (j *ShipyardV20JsonHeader) UnmarshalJSON(b []byte) error {
	...
	type Plain ShipyardV20JsonHeader
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = ShipyardV20JsonHeader(plain)
	return nil
}

type ShipyardV20JsonMessage struct {
	...
	// Ships corresponds to the JSON schema field "ships".
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *ShipyardV20JsonMessage) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	...
	if v, ok := raw["ships"]; !ok || v == nil {
		return fmt.Errorf("field ships: required")
	}
	...
	type Plain ShipyardV20JsonMessage
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = ShipyardV20JsonMessage(plain)
	return nil
}

type ShipyardV20Json struct {
	// SchemaRef corresponds to the JSON schema field "$schemaRef".
	SchemaRef string `json:"$schemaRef"`

	// Header corresponds to the JSON schema field "header".
	Header ShipyardV20JsonHeader `json:"header"`

	// Message corresponds to the JSON schema field "message".
	Message ShipyardV20JsonMessage `json:"message"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *ShipyardV20Json) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	...
	type Plain ShipyardV20Json
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = ShipyardV20Json(plain)
	return nil
}
